...
color <- shape <- c()
########################
A_Give = model_dat_su$Give
A_Exploit = model_dat_su$Exploit
A_Reduce = model_dat_su$Reduce
A_Selfish = model_dat_su$Selfish
A_Generous = model_dat_su$Generous
