...
calming_como = c("#34261D", "#A96922", "#7D370D", "#1C7262","#114B47","#CF821B","#E4A835")
 ...
 df2 = rbind(df2_bs_a, df2_sc_a, df2_su_a)
...
p2a = ggplot(df2, aes(y=Group2,  x=r, xmin=l, xmax=h,color=Site)) +
 ...
 scale_colour_manual(values = c("Coastal" = calming_como[6], "Lowland" = calming_como[3], "Altiplano" = calming_como[1])) + coord_cartesian(xlim = c(-0.75, 1))
p2a
...
################################## Alter
 ...
 df2 = rbind(df2_bs_b, df2_sc_b, df2_su_b)
