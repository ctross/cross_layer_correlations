...
#######################
Give = model_dat_sc$Give
Exploit = model_dat_sc$Exploit
Reduce = model_dat_sc$Reduce
Selfish = model_dat_sc$Selfish
Generous = model_dat_sc$Generous
...
V(graph)$site <- rep("Lowland",length(Standing))
...
ggsave("Punish_SC_Hive.png", P1, height=6, width=8)
ggsave("Give_SC_Hive.png", P3, height=6, width=8.5)
ggsave("Exploit_SC_Hive.png", P2, height=6, width=8)        
